...
class PollsInfo extends React.Component {
  ...
  searchPolls (value) {
    ...
    this.props.loadPollsList(this.props.userID, {first_page: 'first', last_id: this.props.polls.length > 0 ? this.props.polls[this.props.polls.length - 1]._id : 'none', number_of_records: 10, filter_criteria: {search_value: value.toLowerCase(), days: parseInt(this.state.selectedFilterValue)}})
    // var filtered = []
                ...
                <div className='col-lg-12 col-md-12 order-2 order-xl-1'>
                  <div className='form-group m-form__group row align-items-center'>
                    <div className='m-input-icon m-input-icon--left col-md-4 col-lg-4 col-xl-4' style={{marginLeft: '15px'}}>
                      <input type='text' id='searchPoll' name='searchPoll' placeholder='Search by Descripton...' className='form-control m-input m-input--solid' />
