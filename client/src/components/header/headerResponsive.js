            ...
            <div className='mCustomScrollbar' data-mcs-theme='dark'>
              ...
              <ul className='notification-list friend-requests'>
                <li>
                  ...
                  <span className='notification-icon'>
                    <a href='#' className='accept-request'>
                      <span className='icon-add without-text'>
                        <svg className='olymp-happy-face-icon'><use xlinkHref='icons/icons.svg#olymp-happy-face-icon' /></svg>
                      </span>
                    </a>
                  ...
                  <div className='more'>
                    <svg className='olymp-three-dots-icon'><use xlinkHref='icons/icons.svg#olymp-three-dots-icon' /></svg>
                  </div>
                </li>
                <li>
                  <div className='author-thumb'>
                ...
                <li className='accepted'>
                  ...
                  <div className='more'>
                    <svg className='olymp-three-dots-icon'><use xlinkHref='icons/icons.svg#olymp-three-dots-icon' /></svg>
                    <svg className='olymp-little-delete'><use xlinkHref='icons/icons.svg#olymp-little-delete' /></svg>
                  </div>
                </li>
                <li>
                  <div className='author-thumb'>
            ...
            <div className='mCustomScrollbar' data-mcs-theme='dark'>
              ...
              <ul className='notification-list chat-message'>
                <li className='message-unread'>
                  ...
                  <span className='notification-icon'>
                    <svg className='olymp-chat---messages-icon'><use xlinkHref='icons/icons.svg#olymp-chat---messages-icon' /></svg>
                  </span>
                  <div className='more'>
                    <svg className='olymp-three-dots-icon'><use xlinkHref='icons/icons.svg#olymp-three-dots-icon' /></svg>
                  </div>
            ...
            <div className='mCustomScrollbar' data-mcs-theme='dark'>
              ...
              <ul className='notification-list'>
                <li>
                  ...
                  <span className='notification-icon'>
                    <svg className='olymp-comments-post-icon'><use xlinkHref='icons/icons.svg#olymp-comments-post-icon' /></svg>
                  </span>
                ...
                <li>
                  ...
                  <span className='notification-icon'>
                    <svg className='olymp-heart-icon'><use xlinkHref='icons/icons.svg#olymp-heart-icon' /></svg>
                  </span>
