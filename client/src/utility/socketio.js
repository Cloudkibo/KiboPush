...
socket.on('message', (data) => {
  ...
  } else if (data.action === 'broacast_seen') {
    store.dispatch(allBroadcasts({last_id: 'none', number_of_records: 10, first_page: 'first', filter: false, filter_criteria: {search_value: '', type_value: '', days: '0'}}))
