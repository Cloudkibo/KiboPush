...
export const FETCH_WHATSAPP_SESSIONS = 'FETCH_WHATSAPP_SESSIONS'
...
// constants for whatsAppDashboard
export const WHATSAPP_SENT_SEEN = 'WHATSAPP_SENT_SEEN'
export const WHATSAPP_CARDBOXES_DATA = 'WHATSAPP_CARDBOXES_DATA'
export const WHATSAPP_SUBSCRIBER_SUMMARY = 'WHATSAPP_SUBSCRIBER_SUMMARY'
