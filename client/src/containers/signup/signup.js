                  ...
                  <div className='m-login__signup'>
                    ...
                    <form onSubmit={this.onSubmit} className='m-login__form m-form'>
                      ...
                      </div>
                      {
                        ...
                        <div>
                        <div className='form-group m-form__group'>
                          <input className='form-control m-input' type='text' placeholder='Workspace name e.g. mycompany-workspace' ref='domain' required style={{ WebkitBoxShadow: 'none', boxShadow: 'none', height: '45px' }}
                            onChange={this.check} />
                      ...
                      <div className='form-group m-form__group'>
                        <input className='form-control m-input m-login__form-input--last' type='password' required placeholder='Confirm Password' ref='rpassword' style={{ WebkitBoxShadow: 'none', boxShadow: 'none', height: 'none' }}
                          onChange={this.equal} />
