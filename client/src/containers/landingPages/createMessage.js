          ...
          <div className='row'>
            ...
            <div className='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
              ...
              <div className='row'>
                ...
                <button onClick={this.gotoLandingPage} style={{float: 'left', marginLeft: 20, marginTop: '20px'}} className='btn btn-primary'> Back </button>
              </div>
            </div>
            <div className='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
              <StickyDiv zIndex={1}>
                <div style={{border: '1px solid #ccc', borderRadius: '0px', backgroundColor: '#e1e3ea'}} className='ui-block'>
                  <div style={{padding: '5px'}}>
                    <h3>Landing Page Opt-In Message</h3>
                  </div>
                </div>
              </StickyDiv>
