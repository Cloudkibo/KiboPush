                             ...
                             this.props.pagesData.map((page, i) => (
                               <div className='m-widget4__item' key={i}>
                                 ...
                                 <div className='m-widget4__ext'>
                                   <Link style={{marginRight: '20px', whiteSpace: 'normal'}} onClick={(e) => { let pageSelected = page; this.onPageClick(e, pageSelected) }} to={'/viewPageSubscribers'} className='m-btn m-btn--pill m-btn--hover-brand btn btn-sm btn-secondary'>
                                    See Subscribers
                                  </Link>
                                 </div>
                               </div>
