  ...
  componentDidMount () {
    if (this.props.cards && this.props.cards.length > 0) {
      ...
      for (var k = 0; k < this.props.cards.length; k++) {
        tmp.push({element: <Card id={k} img={this.props.cards[k].image_url} title={this.props.cards[k].title} subtitle={this.props.cards[k].subtitle} handleCard={this.handleCard} />, key: k})
      }
