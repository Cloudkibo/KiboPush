                        ...
                        <div className='tab-pane fade active in' id='tab_1'>
                          <div className='row'>
                            <div className='col-lg-6 col-md-6 col-sm-12 col-xs-12'>
                              <div className='row' >
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' id='text' onClick={() => { var temp = this.state.list; this.msg.info('New Text Component Added'); this.setState({list: [...temp, <Text id={new Date().getTime()} key={new Date().getTime()} handleText={this.handleText} onRemove={this.removeComponent} removeState />]}); this.handleText({id: new Date().getTime(), text: '', button: []}) }}>
                                ...
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New Image Component Added'); this.setState({list: [...temp, <Image id={new Date().getTime()} key={new Date().getTime()} handleImage={this.handleImage} onRemove={this.removeComponent} />]}); this.handleImage({id: new Date().getTime(), componentType: 'image', image_url: '', fileurl: ''}) }}>
                                    <div className='align-center'>
                                ...
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New Card Component Added'); this.setState({list: [...temp, <Card id={new Date().getTime()} key={new Date().getTime()} handleCard={this.handleCard} onRemove={this.removeComponent} singleCard />]}); this.handleCard({id: new Date().getTime(), componentType: 'card', title: '', description: '', fileurl: '', buttons: []}) }}>
                                    <div className='align-center'>
                                ...
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New Gallery Component Added'); this.setState({list: [...temp, <Gallery id={new Date().getTime()} key={new Date().getTime()} handleGallery={this.handleGallery} onRemove={this.removeComponent} />]}); this.handleGallery({id: new Date().getTime(), componentType: 'gallery', cards: []}) }}>
                                    <div className='align-center'>
                              ...
                              <div className='row'>
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New Audio Component Added'); this.setState({list: [...temp, <Audio id={new Date().getTime()} key={new Date().getTime()} handleFile={this.handleFile} onRemove={this.removeComponent} />]}); this.handleFile({id: new Date().getTime(), componentType: 'audio', fileurl: ''}) }}>
                                    <div className='align-center'>
                                ...
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New Video Component Added'); this.setState({list: [...temp, <Video id={new Date().getTime()} key={new Date().getTime()} handleFile={this.handleFile} onRemove={this.removeComponent} />]}); this.handleFile({id: new Date().getTime(), componentType: 'video', fileurl: ''}) }}>
                                    <div className='align-center'>
                                ...
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New File Component Added'); this.setState({list: [...temp, <File id={new Date().getTime()} key={new Date().getTime()} handleFile={this.handleFile} onRemove={this.removeComponent} />]}); this.handleFile({id: new Date().getTime(), componentType: 'file', fileurl: ''}) }}>
                                    <div className='align-center'>
                                ...
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New List Component Added'); this.setState({list: [...temp, <List id={new Date().getTime()} key={new Date().getTime()} handleList={this.handleList} onRemove={this.removeComponent} />]}); this.handleList({id: new Date().getTime(), componentType: 'list', listItems: [], topElementStyle: 'compact'}) }}>
                                    <div className='align-center'>
                              ...
                              <div className='row'>
                                <div className='col-3'>
                                  <div className='ui-block hoverbordercomponent' onClick={() => { var temp = this.state.list; this.msg.info('New Media Component Added'); this.setState({list: [...temp, <Media id={new Date().getTime()} key={new Date().getTime()} handleMedia={this.handleMedia} onRemove={this.removeComponent} />]}); this.handleMedia({id: new Date().getTime(), componentType: 'media', fileurl: '', buttons: []}) }}>
                                    <div className='align-center'>
