    ...
    if (this.props.cards && this.props.cards.length > 0) {
      ...
      for (var k = 0; k < cardLength; k++) {
        if (this.props.cards[k] && this.props.cards[k].id === k + 1) {
          tmp.push({element: <Card pages={this.props.pages} pageId={this.props.pageId} replyWithMessage={this.props.replyWithMessage} id={k} buttonActions={this.props.buttonActions} button_id={this.props.id} buttons={this.props.cards[k].buttons} cardDetails={this.props.cards[k]} handleCard={this.handleCard} topElementStyle={this.topElementStyle} removeElement={this.removeElement} topStyle={this.props.list.topElementStyle} />, key: k})
        } else {
