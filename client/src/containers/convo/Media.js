    ...
    return (
      <div className='broadcast-component' style={{marginBottom: 40 + 'px'}}>
        ...
        { this.state.button.length < 3 &&
          <Button module={this.props.module} pages={this.props.pages} button_id={this.props.button_id !== null ? (this.props.button_id + '-' + this.props.id) : this.props.id} onAdd={this.addButton} styling={this.state.styling} />
        }
      </div>
    )
  }
