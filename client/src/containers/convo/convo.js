...
class Convo extends React.Component {
  constructor (props, context) {
    ...
    props.allBroadcasts({last_id: 'none', number_of_records: 10, first_page: true, filter: false, filter_criteria: {searh_value: '', type_value: '', days: 0}})
  ...
  onDaysChange (e) {
    ...
    if (value && value !== '') {
      ...
      this.props.allBroadcasts({last_id: 'none', number_of_records: 10, first_page: true, filter: true, filter_criteria: {searh_value: this.state.searchValue, type_value: this.state.filterValue, days: value}})
      //  this.props.loadBroadcastsList(value)
    } else if (value === '') {
      this.setState({selectedDays: '', filter: false})
      this.props.allBroadcasts({last_id: 'none', number_of_records: 10, first_page: true, filter: false, filter_criteria: {searh_value: this.state.searchValue, type_value: this.state.filterValue, days: 0}})
    }
  }
  scrollToTop () {
  ...
  handlePageClick (data) {
    this.props.allBroadcasts({last_id: this.props.broadcasts[this.props.broadcasts.length - 1]._id, number_of_records: 10, first_page: false, filter: this.state.filter, filter_criteria: {searh_value: this.state.searchValue, type_value: this.state.filterValue, days: this.state.selectedDays}})
  ...
  searchBroadcast (event) {
    ...
    if (event.target.value !== '') {
      this.setState({filter: true})
      this.props.allBroadcasts({last_id: this.props.broadcasts[this.props.broadcasts.length - 1]._id, number_of_records: 10, first_page: true, filter: true, filter_criteria: {searh_value: event.target.value, type_value: this.state.filterValue, days: this.state.selectedDays}})
      ...
      this.props.allBroadcasts({last_id: this.props.broadcasts[this.props.broadcasts.length - 1]._id, number_of_records: 10, first_page: true, filter: false, filter_criteria: {searh_value: '', type_value: this.state.filterValue, days: this.state.selectedDays}})
  ...
  onFilter (e) {
    ...
    if (e.target.value !== '') {
      this.setState({filter: true})
      this.props.allBroadcasts({last_id: this.props.broadcasts[this.props.broadcasts.length - 1]._id, number_of_records: 10, first_page: true, filter: true, filter_criteria: {searh_value: this.state.searchValue, type_value: e.target.value, days: this.state.selectedDays}})
      // for (let i = 0; i < this.props.broadcasts.length; i++) {
      ...
      this.setState({filter: false})
      this.props.allBroadcasts({last_id: this.props.broadcasts[this.props.broadcasts.length - 1]._id, number_of_records: 10, first_page: true, filter: false, filter_criteria: {searh_value: this.state.searchValue, type_value: '', days: this.state.selectedDays}})
      // filtered = this.props.broadcasts
    }
    // this.displayData(0, filtered)
    // this.setState({ totalLength: filtered.length })
