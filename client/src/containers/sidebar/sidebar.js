		...
		<div className="mCustomScrollbar" data-mcs-theme="dark">
          ...
          <Link to="dashboard" data-toggle="tooltip">
            <svg className="olymp-newsfeed-icon left-menu-icon">
              <use xlinkHref="icons/icons.svg#olymp-newsfeed-icon"></use>
            </svg>
					</Link>
				</li>
				<li>
          <Link to="subscribers">
            <svg className="olymp-star-icon left-menu-icon">
              <use xlinkHref="icons/icons.svg#olymp-happy-faces-icon"></use>
            </svg>
					</Link>
				</li>
				<li>
            ...
            <svg className="olymp-badge-icon left-menu-icon">
              <use xlinkHref="icons/icons.svg#olymp-badge-icon"></use>
            </svg>
					</Link>
				</li>
				<li>
          <Link to="surveys">
            <svg className="olymp-calendar-icon left-menu-icon">
              <use xlinkHref="icons/icons.svg#olymp-calendar-icon"></use>
            </svg>
					</Link>
				</li>
				<li>
          <Link to="workflows">
            <svg className="olymp-happy-faces-icon left-menu-icon">
              <use xlinkHref="icons/icons.svg#olymp-star-icon"></use>
            </svg>
					</Link>
				</li>
				<li>
          <Link to="poll">
            <svg className="olymp-headphones-icon left-menu-icon">
              <use xlinkHref="icons/icons.svg#olymp-manage-widgets-icon"></use>
            </svg>
					</Link>
				</li>
					<li>
          ...
          <Link to="stats">
            <svg className="olymp-stats-icon left-menu-icon">
              <use xlinkHref="icons/icons.svg#olymp-stats-icon"></use>
            </svg>
					</Link>
				</li>
				<li>
