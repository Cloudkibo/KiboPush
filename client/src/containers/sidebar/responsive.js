              ...
              <div className='author-page author vcard inline-items'>
                ...
                <a href='02-ProfilePage.html' className='author-name fn'>
                  <div className='author-title'>
							James Spiegel <svg className='olymp-dropdown-arrow-icon'><use xlinkHref='icons/icons.svg#olymp-dropdown-arrow-icon' /></svg>
                  </div>
            ...
            <ul className='left-menu'>
              ...
              <li>
                <a href='mobile-index.html'>
                  <svg className='olymp-newsfeed-icon left-menu-icon' data-toggle='tooltip' data-placement='right' title='' data-original-title='NEWSFEED'><use xlinkHref='icons/icons.svg#olymp-newsfeed-icon' /></svg>
                  <span className='left-menu-title'>Newsfeed</span>
                </a>
              </li>
              <li>
                <a href='Mobile-28-YourAccount-PersonalInformation.html'>
                  <svg className='olymp-star-icon left-menu-icon' data-toggle='tooltip' data-placement='right' title='' data-original-title='FAV PAGE'><use xlinkHref='icons/icons.svg#olymp-star-icon' /></svg>
                  <span className='left-menu-title'>Fav Pages Feed</span>
                </a>
              </li>
              <li>
                <a href='mobile-29-YourAccount-AccountSettings.html'>
                  <svg className='olymp-happy-faces-icon left-menu-icon' data-toggle='tooltip' data-placement='right' title='' data-original-title='FRIEND GROUPS'><use xlinkHref='icons/icons.svg#olymp-happy-faces-icon' /></svg>
                  <span className='left-menu-title'>Friend Groups</span>
                </a>
              </li>
              <li>
                <a href='Mobile-30-YourAccount-ChangePassword.html'>
                  <svg className='olymp-headphones-icon left-menu-icon' data-toggle='tooltip' data-placement='right' title='' data-original-title='MUSIC&PLAYLISTS'><use xlinkHref='icons/icons.svg#olymp-headphones-icon' /></svg>
                  <span className='left-menu-title'>Music & Playlists</span>
                </a>
              </li>
              <li>
                <a href='Mobile-31-YourAccount-HobbiesAndInterests.html'>
                  <svg className='olymp-weather-icon left-menu-icon' data-toggle='tooltip' data-placement='right' title='' data-original-title='WEATHER APP'><use xlinkHref='icons/icons.svg#olymp-weather-icon' /></svg>
              ...
              <li>
                <a href='Mobile-34-YourAccount-ChatMessages.html'>
                  <svg className='olymp-cupcake-icon left-menu-icon' data-toggle='tooltip' data-placement='right' title='' data-original-title='Friends Birthdays'><use xlinkHref='icons/icons.svg#olymp-cupcake-icon' /></svg>
