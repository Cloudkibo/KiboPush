                ...
                <div className='friend-item'>
                  ...
                  <div className='friend-item-content'>
                    ...
                    <div className='swiper-container swiper-swiper-unique-id-2 initialized swiper-container-horizontal' id='swiper-unique-id-2'>
                      ...
                      <div className='swiper-pagination pagination-swiper-unique-id-2 swiper-pagination-clickable swiper-pagination-bullets'><span className='swiper-pagination-bullet swiper-pagination-bullet-active' /><span className='swiper-pagination-bullet' /></div>
                    </div>
                  </div>
                </div>
              </div>
