...
export function validateCommaSeparatedPhoneNumbers(numbers) {
  const regex = /^\+(9[976]\d|8[987530]\d|6[987]\d|5[90]\d|42\d|3[875]\d|2[98654321]\d|9[8543210]|8[6421]|6[6543210]|5[87654321]|4[987654310]|3[9643210]|2[70]|7|1)\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*(\d{1,2})(,\+(9[976]\d|8[987530]\d|6[987]\d|5[90]\d|42\d|3[875]\d|2[98654321]\d|9[8543210]|8[6421]|6[6543210]|5[87654321]|4[987654310]|3[9643210]|2[70]|7|1)\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*(\d{1,2}))*$/g
...
export function getCurrentProduct() {
  ...
  if (hostname.includes('kiboengage.cloudkibo.com') || window.location.port.includes('3021')) {
    ...
    return 'KiboChat'
  } else if (hostname.includes('kibolite.cloudkibo.com') || window.location.port.includes('8000')) {
...
export function isTimeInInterval(startTime, endTime, date) {
  ...
  console.log('dt1', dt1)
  console.log('dt2', dt2)
  console.log('valid', date >= dt1 && date <= dt2)
