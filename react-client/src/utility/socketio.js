...
socket.on('message', (data) => {
  ...
  if (['new_chat_whatsapp', 'agent_replied_whatsapp', 'session_pending_response_whatsapp', 'unsubscribe_whatsapp', 'session_status_whatsapp', 'new_session_created_whatsapp', 'message_status_whatsApp'].includes(data.action)) {
