...
class CustomerMatching extends React.Component {
  constructor(props, context) {
    ...
    this.props.loadCustomerListsNew({
      last_id: "none",
  ...
  onSubmit() {
    ...
    if (file && file !== "") {
      ...
      for (var i = 0; i < this.state.customerLists.length; i++) {
        ...
        if (
          list.initialList &&
          list.listName.toLowerCase() === name[0].toLowerCase()
        ) {
          nameExists = true;
          break;
        }
  ...
  onFilesChange(files) {
    ...
    if (files.length > 0) {
      ...
      if (fileSelected.extension !== "csv") {
        this.setState({
          fileErrors: [
            { errorMsg: "Please select a file with .csv extension" },
          ],
        });
        return;
      }
  ...
  validateFileContent() {
    ...
    for (let i = 1; i < content.length; i++) {
      ...
      if (recordName && recordName.length > 50) {
        faulty = true;
        let error = {
          errorMsg: "File consists of customer names that is too long",
        };
        errors.push(error);
        break;
      }
      if (
        recordPhone &&
        ((recordPhone.length > 0 && recordPhone.length < 5) ||
          !regexp.test(recordPhone))
      ) {
        faulty = true;
  ...
  onPhoneNumbersChange(e) {
    ...
    if (
      ...
      ((this.state.file && this.state.file !== "") || e.target.value !== "")
    ) {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (
      nextProps.nonSubscribersNumbers &&
      nextProps.nonSubscribersNumbers.length > 0
    ) {
      this.setState({
    ...
    return (
      <div className="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <a
          href="#/"
          style={{ display: "none" }}
          ref="videoCustomerMatching"
          data-toggle="modal"
          data-backdrop="static"
          data-keyboard="false"
          data-target="#videoCustomerMatching"
        >
          videoCustomerMatching
        </a>
        <div
          style={{ background: "rgba(33, 37, 41, 0.6)" }}
          className="modal fade"
          id="videoCustomerMatching"
          tabindex="-1"
          role="dialog"
            ...
            <div className="modal-content">
              ...
              <div style={{ color: "black" }} className="modal-body">
                <div className="form-group m-form__group col-12">
                  ...
                  {this.state.columnAlerts && this.state.nameColumn === "" && (
                ...
                <div className="form-group m-form__group col-12">
                  ...
                  {this.state.columnAlerts && this.state.phoneColumn === "" && (
                    <span className="m-form__help">
                      <span style={{ color: "red", paddingLeft: "14px" }}>
                        Select a field
                      </span>
                ...
                {this.state.columnAlerts &&
                  this.state.nameColumn !== "" &&
                  this.state.nameColumn.value ===
                    this.state.phoneColumn.value && (
                    <span className="m-form__help">
                      <span style={{ color: "red", marginLeft: "28px" }}>
                        {" "}
                        You cannot select same fields for both columns
                      </span>
                    </span>
                  )}
                <button
                  ...
                  disabled={!this.state.phoneColumn}
                  onClick={() => {
                    this.saveColumns();
                  }}
                  data-dismiss="modal"
        ...
        >
          ...
          >
            <div className="modal-content">
              ...
              <div style={{ color: "black" }} className="modal-body">
                <p>
                  A customer list file name with a similar name exists. Do you
                  want to replace the list ?
                </p>
                <button
                  style={{ float: "right", marginLeft: "10px" }}
                  className="btn btn-primary btn-sm"
          ...
          <div className="d-flex align-items-center">
            <div className="mr-auto">
              <h3 className="m-subheader__title">
                Invite using Phone Number (Experimental Feature)
              </h3>
            </div>
          </div>
        </div>
        <div className="m-content">
          ...
          {this.props.pages && this.props.pages.length === 0 && (
            <div className="alert alert-success">
              ...
              You have no pages connected. Please connect your facebook pages to
              invite customers using phone numbers.{" "}
          ...
          >
            ...
            <div className="m-alert__text">
              Need help in understanding Invite Using Phone Numbers? Here is the{" "}
              <a
                href="http://kibopush.com/invite-using-phone-numbers/"
                target="_blank"
          ...
          >
            ...
            <div className="m-alert__text">
              Upload a file with '.csv' extension containing phone numbers of
              your customers to invite them for a chat on messenger. Then select
              columns from your file that contain customers&#39; names and phone
              numbers. An invitation message will be sent on Facebook messenger
              to all the customers listed using their phone numbers.
              <br />
              <br />
              <b>Note: </b>This is an experimental feature and it is specific
              for pages that belong to United States of America (One of the page
              admins should be from USA). There is a one time fee for each page
              that you have connected. For further Details on how to make the
              payment, please contact us{" "}
              <a
                href="https://www.messenger.com/t/kibopush"
                target="_blank"
                rel="noopener noreferrer"
              >
                here
              ...
              <div className="m-portlet m-portlet--mobile">
                    ...
                    {this.state.customerLists.length === 0 ? (
                      ...
                      >
                        <span>
                          ...
                          <span>View Customers Lists</span>
                        </span>
                      </Link>
                    ) : (
                      <Link
                ...
                <div className="m-portlet__body">
                  <div className="form-group m-form__group row">
                    <label className="col-2 col-form-label">Change Page</label>
                    <div className="col-6">
                      <select
                        className="form-control m-input"
                        value={this.state.selectPage.pageId}
                      ...
                      {this.state.file !== "" ? (
                        ...
                        >
                          <div style={{ marginTop: "10%" }}>
                            ...
                            {this.state.fileErrors.length < 1 && (
                              <button
                          ...
                          <span className="m-form__help">
                            {this.state.fileErrors.map((m) => (
                              <span style={{ color: "red" }}>{m.errorMsg}</span>
                            ))}
                          </span>
                        </div>
                      ) : (
                        ...
                        >
                          {this.state.manually ? (
                            <div>
                              <label>
                                {
                                  "Enter phone number separated by semi colon {;}"
                                }
                              </label>
                              <input
                                autoFocus
                                ref={(input) => {
                                  this.inputPhoneNumbers = input;
                                }}
                                type="text"
                                className="form-control m-input m-input--square"
                                onChange={this.onPhoneNumbersChange}
                                placeholder="+923322735478;+14258909414"
                              />
                              {this.state.numbersError.length > 0 && (
                                <span className="m-form__help">
                                  <span style={{ color: "red" }}>
                                    One or more numbers are incorrect. Please
                                    make sure that all numbers must start with +
                                    sign.
                                  </span>
                                </span>
                              )}
                            ...
                            <button
                              ...
                              onClick={() => this.enterPhoneNoManually()}
                              className="btn m-btn--pill btn-success"
                            >
                  ...
                  <div className="form-group m-form__group row">
                    ...
                    <div className="col-lg-6">
                      ...
                      />
                      <span className="m-form__help">
                        {this.state.messageErrors.map((m) => (
                          <span style={{ color: "red" }}>{m.errorMsg}</span>
                        ))}
                      </span>
                    </div>
