...
class Analytics extends React.Component {
  ...
  componentDidMount() {
    ...
    document.title = 'KiboChat | WhatsApp Airlines Chatbot Analytics'
  }
  ...
  onBack() {
    this.props.history.push({
      pathname: '/whatsAppAirlinesChatbot'
    })
  }
              ...
              <div className='m-subheader '>
                ...
                <div className='d-flex align-items-center'>
                  <div className='mr-auto'>
                    <h3 className='m-subheader__title'>Airlines Chatbot Analytics</h3>
                  </div>
                </div>
              </div>
