                          ...
                          <tbody className='m-datatable__body'>
                            {
                              this.state.pagesData.filter((p) => p.connected).map((page, i) => (
                                <tr data-row={i}
                                  ...
                                  <td data-field='name' className='m-datatable__cell--center m-datatable__cell'><span style={{ width: '100px' }}>{page.pageName}</span></td>
                                  <td data-field='type' className='m-datatable__cell--center m-datatable__cell'><span style={{ width: '100px' }}>{page.likes}</span></td>
                                  <td data-field='description' className='m-datatable__cell--center m-datatable__cell'><span style={{ width: '100px' }}>{page.subscribers}</span></td>
