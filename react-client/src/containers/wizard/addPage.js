            ...
            <div className='m-portlet__body m-portlet__body--no-padding'>
              <div className='m-wizard m-wizard--4 m-wizard--brand m-wizard--step-first' id='m_wizard'>
                <div className='row m-row--no-padding' style={{ marginLeft: '0', marginRight: '0', display: 'flex', flexWrap: 'wrap' }}>
                  ...
                  <div className='col-md-9 col-12 m-portlet m-portlet--tabs' style={{ padding: '1rem 2rem 4rem 2rem', borderLeft: '0.07rem solid #EBEDF2', color: '#575962', lineHeight: '1.5', boxShadow: 'none' }}>
                                          ...
                                          <div className='m-widget4__item' key={i + '-addPageItem'}>
                                            ...
                                            <div className='m-widget4__ext'>
                                              ...
                                              {(!page.connected) &&
                                                ...
                                                <a href='#/' onClick={() => this.props.enablePage(page, null, this.msg)} className='m-widget4__icon'>
