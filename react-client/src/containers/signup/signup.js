              ...
              <div className='m-stack__item m-stack__item--fluid'>
                <div className='m-login__wrapper'>
                  ...
                  <div className='m-login__signup'>
                      ...
                      <form onSubmit={this.onSubmit} className='m-login__form m-form'>
                        ...
                        <div className='m-login__form-action'>
                          <div className='checkbox'>
                            ...
                            <label style={{ marginBottom: 35, marginLeft: 0, fontSize: 13, paddingLeft: 0 }}>I've read and accept the <a data-toggle="modal" data-target="#agreement" onClick={this.showDialog} href='#eulaAgreement'>terms and conditions</a></label>
                          </div>
                    ...
                    <div style={{ background: 'rgba(33, 37, 41, 0.6)' }} className="modal fade" id="agreement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
