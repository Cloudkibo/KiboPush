     ...
     <div style={{width:'100%', height:'100%'}}>
        ...
        <div className='col-12' style={{width: '100%',height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', textAlign: 'center'}}>
          <div>
            ...
            <br />
            { this.props.widgetType !== 'bar' &&
            <textarea value={this.props.submittedState.description} rows='2' style={{fontWeight: '300', fontSize: 'small', border:'1px dashed lightgray', textAlign: 'center', height: 'auto', width: `${this.props.widgetType === 'page_takeover' ? '400px': '320px'}`, margin: '10px', background: this.props.submittedState.background_color, color: this.props.submittedState.description_color}} maxLength='100' onChange={this.props.handleDescriptionChange} />
            }
            <div className='btn' style={{marginTop: '10px', backgroundColor: `${this.props.submittedState.button_background}`, padding: '5px'}}>
              <textarea style={{ margin: '1px 1px -4px 1px', padding: '5px',resize: 'none', width: '180px', border:'1px dashed lightgray', textAlign: 'center',height: '32px', 'background': `${this.props.submittedState.button_background}`, 'color': `${this.props.submittedState.button_text_color}`}} value={this.props.submittedState.button_text} maxLength='25' onChange={this.props.changeButtonText} />
            </div>
          </div>
        </div>
      </div>
