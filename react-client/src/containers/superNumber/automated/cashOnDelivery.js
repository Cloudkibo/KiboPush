...
import { fetchShopifyStore, fetchSuperNumberPreferences, updateSuperNumberPreferences, createSuperNumberPreferences } from '../../../redux/actions/commerce.actions'
...
class CashOnDelivery extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      enabled: false,
      codTags: {
        cancelTag: 'CODCancelled-KiboPush',
        confirmTag: 'CODConfirmed-KiboPush',
        noResponseTag: 'CODNoResponse-KiboPush'
      }
    }
