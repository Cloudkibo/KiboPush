...
class ChatBox extends React.Component {
  ...
  componentDidUpdate (nextProps) {
    ...
    if (this.props.socketData && this.props.socketData.subscriber_id === this.props.currentSession._id && this.props.socketData.message.sender_id.id !== this.props.user._id) {
      this.previousScrollHeight = this.refs.chatScroll.scrollHeight
