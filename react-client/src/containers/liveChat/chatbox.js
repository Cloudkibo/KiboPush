          ...
          <div style={{padding: '1.3rem', borderBottom: '1px solid #ebedf2'}}>
            <button style={{backgroundColor: 'white'}} className='btn'>Status: {this.props.currentSession.is_assigned ? 'Assigned' : 'Unassigned'}</button>
            {
              ...
              ? <div style={{float: 'right'}}>
                ...
                ? <i id='resolve_session_in_checkbox' style={{cursor: 'pointer', color: '#212529', fontSize: '25px', marginRight: '5px'}} onClick={() => this.showDialogPending(false)} data-toggle="modal" data-target="#pendingResponse" data-tip='Remove Pending Flag' className='la la-user-times' />
              : <i id='resolve_session_in_checkbox' style={{cursor: 'pointer', color: '#212529', fontSize: '25px', marginRight: '5px'}} onClick={() => this.showDialogPending(true)} data-toggle="modal" data-target="#pendingResponse"  data-tip='Add Pending Flag' className='la la-user-plus' />
                }
