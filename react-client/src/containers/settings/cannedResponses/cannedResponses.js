            ...
            <div className='m-content'>
              <div className='row'>
                  <div className='col-7 input-group'>
                     <input className="form-control m-input m-input--solid" type="text" placeholder="Search Scanned Responses..." aria-label="Search" />
                  </div>
              </div>
              <div
           ...
           >
             <span style={{ width: '20px' }}>
               <a
                 ...
                 data-value={i}
                //  onClick={() => this.expendRowToggle(scannedResponse, i)}
