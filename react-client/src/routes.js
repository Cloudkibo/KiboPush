...
const SLADashboard = asyncComponent(() => import("./containers/SLA_Dashboard/sla_dashboard"))
...
const Routes = () => (
  <Switch>
    ...
    <Route
      path="/WhatsAppCommerceChatbotAnalytics"
      component={WhatsAppCommerceChatbotAnalytics}
      onEnter={requireAuth}
    />
    <Route path="/WhatsAppAirlinesChatbot" component={WhatsAppAirlinesChatbot} onEnter={requireAuth} />
    <Route
      path="/WhatsAppAirlinesChatbotAnalytics"
      component={WhatsAppAirlinesChatbotAnalytics}
      onEnter={requireAuth}
    />
    <Route path="/commerceChatbotAnalytics" component={CommerceChatbotAnalytics} onEnter={requireAuth} />
    <Route path="/commerceChatbotAnalytics" component={CommerceChatbotAnalytics} onEnter={requireAuth} />
    <Route path="/slaDashboard" component={SLADashboard} onEnter={requireAuth} />
