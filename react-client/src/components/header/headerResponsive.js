              ...
              <ul className='notification-list friend-requests'>
                <li>
                  ...
                  <div className='notification-event'>
                    <a href='#' className='h6 notification-friend'>Tamara
                      Romanoff</a>
                    ...
                    <a href='#' className='accept-request'>
                      <span className='icon-add without-text'>
                        <svg className='olymp-happy-face-icon'><use
                          xlinkHref='icons/icons.svg#olymp-happy-face-icon' /></svg>
                      </span>
                    </a>
                ...
                <li>
                  ...
                  <div className='notification-event'>
                    <a href='#' className='h6 notification-friend'>Tony
                      Stevens</a>
                    <span
                      className='chat-message-item'>4 Friends in Common</span>
                  </div>
                  <span className='notification-icon'>
                    <a href='#' className='accept-request'>
                      <span className='icon-add without-text'>
                ...
                <li className='accepted'>
                  ...
                  <div className='notification-event'>
                    You and <a href='#' className='h6 notification-friend'>Mary
                    Jane Stark</a> just became friends. Write on <a href='#'
                      className='notification-link'>her
                    wall</a>.
                  </div>
                  <span className='notification-icon'>
                    <svg className='olymp-happy-face-icon'><use
                  ...
                  <div className='more'>
                    ...
                    <svg className='olymp-little-delete'>
                      <use xlinkHref='icons/icons.svg#olymp-little-delete' />
                    </svg>
                  </div>
                </li>
                <li>
                  ...
                  <div className='notification-event'>
                    <a href='#' className='h6 notification-friend'>Stagg
                      Clothing</a>
                    <span
                      className='chat-message-item'>9 Friends in Common</span>
                  </div>
                  <span className='notification-icon'>
                    <a href='#' className='accept-request'>
                      <span className='icon-add without-text'>
            ...
            <div className='mCustomScrollbar' data-mcs-theme='dark'>
              ...
              <ul className='notification-list chat-message'>
                <li className='message-unread'>
                  ...
                  <div className='notification-event'>
                    <a href='#' className='h6 notification-friend'>Diana
                      Jameson</a>
                  ...
                  <span className='notification-icon'>
                    <svg className='olymp-chat---messages-icon'><use
                      xlinkHref='icons/icons.svg#olymp-chat---messages-icon' /></svg>
                  </span>
                  <div className='more'>
                    <svg className='olymp-three-dots-icon'>
                      <use xlinkHref='icons/icons.svg#olymp-three-dots-icon' />
                ...
                <li>
                  ...
                  <div className='notification-event'>
                    <a href='#' className='h6 notification-friend'>Jake
                      Parker</a>
                ...
                <li>
                  ...
                  <div className='notification-event'>
                    <a href='#' className='h6 notification-friend'>Elaine
                      Dreyfuss</a>
                ...
                <li className='chat-group'>
                  ...
                  <div className='notification-event'>
                    <a href='#' className='h6 notification-friend'>You, Faye,
                      Ed &amp; Jet +3</a>
                    <span className='last-message-author'>Ed:</span>
                    <span
                      className='chat-message-item'>Yeah! Seems fine by me!</span>
                    <span className='notification-date'><time
                      className='entry-date updated'
            ...
            <div className='mCustomScrollbar' data-mcs-theme='dark'>
              ...
              <ul className='notification-list'>
                <li>
                  ...
                  <div className='notification-event'>
                    <div><a href='#' className='h6 notification-friend'>Mathilda
                      Brinker</a> commented on your new <a href='#'
                        className='notification-link'>profile
                      status</a>.
                    </div>
                    <span className='notification-date'><time
                      className='entry-date updated'
                  ...
                  <span className='notification-icon'>
                    <svg className='olymp-comments-post-icon'><use
                      xlinkHref='icons/icons.svg#olymp-comments-post-icon' /></svg>
                  </span>
                ...
                <li className='un-read'>
                  ...
                  <div className='notification-event'>
                    <div>You and <a href='#' className='h6 notification-friend'>Nicholas
                      Grissom</a> just became friends. Write on <a href='#'
                        className='notification-link'>his
                      wall</a>.
                    </div>
                    <span className='notification-date'><time
                      className='entry-date updated'
                ...
                <li className='with-comment-photo'>
                  ...
                  <div className='notification-event'>
                    <div><a href='#' className='h6 notification-friend'>Sarah
                      Hetfield</a> commented on your <a href='#'
                        className='notification-link'>photo</a>.
                    </div>
                    <span className='notification-date'><time
                      className='entry-date updated'
                ...
                <li>
                  ...
                  <div className='notification-event'>
                    <div><a href='#' className='h6 notification-friend'>Green
                      Goo Rock</a> invited you to attend to his event Goo in <a
                        href='#' className='notification-link'>Gotham Bar</a>.
                    </div>
                    <span className='notification-date'><time
                      className='entry-date updated'
                ...
                <li>
                  ...
                  <div className='notification-event'>
                    <div><a href='#' className='h6 notification-friend'>James
                      Summers</a> commented on your new <a href='#'
                        className='notification-link'>profile
                      status</a>.
                    </div>
                    <span className='notification-date'><time
                  ...
                  <span className='notification-icon'>
                    <svg className='olymp-heart-icon'><use
                      xlinkHref='icons/icons.svg#olymp-heart-icon' /></svg>
                  </span>
              ...
              <a href='#' className='view-all bg-primary'>View All
                Notifications</a>
            </div>
