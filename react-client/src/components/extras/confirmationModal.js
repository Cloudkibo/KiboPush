...
class ConfirmationModal extends React.Component {
  render () {
    return (
      <div style={{ background: 'rgba(33, 37, 41, 0.6)', zIndex: 99991 }} className="modal fade" id={this.props.id} tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
