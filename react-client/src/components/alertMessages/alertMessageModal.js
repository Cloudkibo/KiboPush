      ...
      <div>
        ...
        ? <div className='m-alert m-alert--icon m-alert--icon-solid m-alert--outline alert alert-warning alert-dismissible fade show' role='alert'>
          ...
          <div className='m-alert__text'>
            ...
            You have no pages connected. Please connect your facebook page by clicking&nbsp; <Link style={{cursor: 'pointer'}} to='/addPages' >here</Link>
        ...
        <div className='m-alert m-alert--icon m-alert--icon-solid m-alert--outline alert alert-warning alert-dismissible fade show' role='alert'>
          ...
          <div className='m-alert__text'>
            ...
            To invite subscribers click <Link to='/invitesubscribers' style={{cursor: 'pointer'}}> here</Link>. You can also watch the video
