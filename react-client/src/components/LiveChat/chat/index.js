...
import { displayDate, showDate } from '../../../containers/liveChat/utilities'
      ...
      case 'sticker':
        popoverOptions.content = (
          <StickerMenu
            ...
            sendSticker={(sticker) => {
              otherOptions.sendSticker(sticker)
            }}
          />
        )
        break
    ...
    return (
      ...
      >
        <div
          ...
          className='m-portlet'
        >
          {!this.props.isMobile && <ReactTooltip place='top' type='dark' effect='solid' />}
          ...
          <CONFIRMATIONMODAL
            ...
            onConfirm={() => {
              this.props.changeStatus('resolved', this.props.activeSession)
            }}
          />
          ...
          <CONFIRMATIONMODAL
            ...
            onConfirm={() => {
              this.props.handlePendingResponse(this.props.activeSession, false)
            }}
          />
          ...
          {!this.props.activeSession.lastMessagedAt ||
          (!moment(this.props.activeSession.lastMessagedAt).isAfter(
            moment().subtract(24, 'hours')
          ) &&
            !this.props.isSMPApproved) ? (
            <div
            ...
            >
              <span>
                <p>
                  Chat's 24 hours window session has been expired for this subscriber. You cannot
                  send a message to this subscriber until they message you.
                </p>
                {this.props.showTemplates && (
                  <a
                    href='#/'
            ...
            >
              <span>
                A user input component was last sent to this subscriber and we are waiting for a
                response from them.
              </span>
              <button
                className='m-link'
          ...
          <div id='_picker'>
            ...
            >
              <PopoverBody>{this.state.popoverOptions.content}</PopoverBody>
            </Popover>
          </div>
        </div>
      </div>
