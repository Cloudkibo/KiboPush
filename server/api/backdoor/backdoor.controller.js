...
exports.sendEmail = function (req, res) {
  ...
  Users.find({}, (err, users) => {
    ...
    users.forEach((user) => {
      let data = {
        date: handleDate(user.createdAt),
        subscribers: 0,
        polls: 0,
        broadcasts: 0,
        surveys: 0,
