              ...
              function (err, gotCountAgent) {
                ...
                if (gotCountAgent > 0) {
                  ...
                  email.setHtml(
                    ...
                    '<tr> <td class="panel" style="background: #ECF8FF;border: 0;padding: 10px !important;"> <a href="https://app.kibopush.com/api/invite_verification/verify/' +
                    uniqueToken_id +
                    '">https://app.kibopush.com/api/invite_verification/verify/' +
                    uniqueToken_id +
