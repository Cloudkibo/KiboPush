    ...
    .then(planUsage => {
      ...
      .then(companyUsage => {
        ...
        .then(companyUser => {
          ...
          utility.callApi(`lists/update`, 'put', {query: query, update: update, options: {upsert: true}}, req.headers.authorization)
          .then(savedList => {
                ...
                .on('data', function (data) {
                  ...
                  .then(phone => {
                    if (phone.length === 0) {
                      ...
                      utility.callApi(`phone/update`, 'put', {query: query, update: update, options: {upsert: true}}, req.headers.authorization)
                        ...
                        .then(number => {
                          if (number.length > 0) {
                            ...
                            .then(subscribers => {
                              ...
                              utility.callApi(`lists/update`, 'put', {query: query, update: update, options: {}}, req.headers.authorization)
                              .then(savedList => {
                              })
                              .catch(error => {
                                return res.status(500).json({
